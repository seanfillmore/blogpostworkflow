...
## Stress-test perceived value with one question — 'if I had to double the price of this offer, how would I justify it?' — then actually build whatever answers it into the offer.

**Why it works:** An offer that cannot survive a doubled price has no headroom over cold-traffic acquisition cost. Forcing yourself to name the justification produces concrete additions — a bundle, a guide, a community, a named program, a stated timeline — that raise perceived value without changing the product or the cost of goods. It is the constructive counterpart to the anti-discount framing above: instead of asking how much price you can give away, it asks what you would have to add before the price stopped mattering.

**Evidence offered:** Case study: test booster + pre-workout + digital guide + community sold as a named 30-day challenge at ~$97 with $69/mo continuity, reported as multiple six figures a month in net profit. Self-reported, single case.

**Fit here (7/10):** Durable offer-construction principle, so age is irrelevant. Directly usable by a solo operator: at a $50.46 AOV against a $30/day Meta campaign, the offer has to carry enough perceived value to cover CAC, and the double-the-price exercise is a 20-minute written test across the 12 SKUs that produces bundle and inclusion ideas at zero cost. Keep it distinct from the price-escalation rule below — that one is price *discovery* against real orders; this is value *construction* before any price moves. The honest answers here are already listed elsewhere in this skill (a named routine bundle, a transition guide, a 30-day guarantee, a stated timeline), so use it as the diagnostic that decides which of those to build first, not as a licence to actually double a $12 stick.
...
**Why it works:** Perceived effort is a purchase and retention cost; removing steps the buyer would otherwise have to figure out makes the experience feel premium without changing the core product.

**Evidence offered:** Assertion plus his own workshop operations (staff knowing attendees' names and businesses on arrival).

**Fit here (6/10):** Durable principle class. For a consumable with an 18–22.5% repeat rate, the ease vector has a concrete form: pre-selected refill bundles and a post-purchase transition-period walkthrough that removes the guesswork that causes churn. Zero cost, solo-executable, and aimed squarely at the binding constraint. Scored 6 rather than higher because the copy layer of onboarding is already covered by the 'how to start' stem in the awareness-level skill — the additive part here is the offer/structure layer (what the refill bundle is), not the wording.
...
**Fit here (8/10):** Durable pricing logic, no decay. This is the single best-fit tactic in the video: deodorant is a consumable, the catalog is 12 SKUs, AOV is $50.46, and repeat purchase is the binding constraint. A multi-unit or mixed-SKU pack sold at an adjusted unit price simultaneously lifts AOV and forward-buys months of supply, which suppresses churn without needing a single new visitor. Executable solo on Shopify today and as a multipack ASIN on Amazon.
...
**Fit here (7/10):** This is a live decision right now: the $30/day Meta campaign points at a soap giveaway — a lead magnet — for a $50.46 AOV consumable that needs almost no education to buy. The rule says run at least one cell straight to a deodorant PDP and judge the two against each other on cost per purchase, not cost per entry. Related to but distinct from the 'simplest possible funnel' claim elsewhere: that governs how many steps sit between the ad and the PDP; this governs whether the thing advertised is the product or a free offer at all. It settles *whether* the ad points at a product; the cohort-repurchase rule below settles *which* product. Treat it as the gate on every lead-magnet rule below — nothing free ships until direct-to-PDP has been given a fair cell.

*Source: Alex Hormozi — "$100M Leads" (book, (part 2 of 16))*

## Pick the product you advertise by which entry SKU's first-time buyers come back most often — not by which SKU sells the most or shows the best front-end ROAS.

**Why it works:** The first order a customer places is the strongest observable predictor of whether they ever order again. Spend acquisition dollars on the SKU whose first-time cohort never repurchases and you buy one-and-done customers, so repeat revenue never compounds no matter how flattering the front-end ROAS looks. Best-seller volume and ROAS both measure the first transaction only; cohort repurchase rate measures the thing that actually determines lifetime value.

**Evidence offered:** Case walkthrough of a ~$2M/yr coffee brand: the best-selling sampler had an ~8% repurchase rate (third worst in the catalog), while Single Origin Ethiopia showed a 35% repurchase rate and already produced more returning revenue than any other SKU off half the first-time customers. Single case, self-reported.

**Fit here (8/10):** Retention is the stated binding constraint and repeat customers are already 45–52% of revenue, so choosing which of 12 SKUs the $30/day Meta campaign points at is exactly the decision that moves the constraint. Runnable today from a Shopify order CSV: for each SKU, take the orders where it was the customer's first purchase and compute what share of those customers ever ordered again. Amazon repeat data is thinner, so the analysis is Shopify-led. This is the empirical version of the 'sticky' score in the four-property rule below — measure it from order history rather than assuming deodorant and oral care win — and it supplies the SKU that the front-end/back-end margin gate above then has to price. At ~54 orders/month per-SKU contrasts are directional rather than significant: run it on all-time order history, not a 90-day window, and treat the ranking as a hypothesis about where to point spend rather than a proof.
...
**Evidence offered:** Assertion plus a title example ('11 frameworks we use to build wildly profitable gyms'); no data.

**Fit here (6/10):** Durable principle class. The Shopify email capture is a live, zero-cost surface, and list growth feeds directly into the retention constraint that is binding here. Directly actionable: replace a generic '10% off' popup with a named, specific incentive tied to what the buyer actually wants. Scored 6 rather than higher because the 'in their own language' half overlaps with the existing review-mining skill — the additive part is choosing the incentive, not phrasing it.

*Source: Hormozi Highlights — "How to Make Better Offers and Lead Magnets" (7qY7gBMWOB4)*

## There are three lead-magnet types: reveal a problem, give a trial of the solution, or hand over one step of a multi-step process.

**Why it works:** Each gives the prospect real value before any commitment while leaving the rest of the job undone, so the opt-in is genuinely worth taking and the remaining gap is what you sell next.
...
**Fit here (6/10):** Durable pricing psychology, no decay, and it has a direct catalog form: lip balm is already the natural low-COGS entry SKU, and the discount-depth rule is an immediate corrective to the reflexive 10%-off popup. Held at 6 because at ~$2,700/mo with solo-funded shipping, an 80–90% off physical entry product can go cash-negative per order once postage is counted — the principle transfers, but only to items where landed cost is genuinely trivial, and the upsell path must exist before the discount ships. Run the splintered item through the front-end margin gate above before it goes behind paid traffic, and check it against the cohort-repurchase ranking — a cheap entry SKU whose first-time buyers never come back is the exact failure that rule describes.

*Source: Hormozi Highlights — "How to Make Better Offers and Lead Magnets" (7qY7gBMWOB4)*

## Give away something other people charge for — the more real the lead magnet's cost, the better it converts.

**Why it works:** Perceived value tracks demonstrable market price. If the thing is visibly something with a price tag elsewhere, the opt-in feels like a genuine win rather than a marketing wrapper.

**Evidence offered:** Stated as his personal preference; assertion only.

**Fit here (6/10):** Durable principle class and a useful selection filter for a business whose products are physical and priced — a real travel-size or a full lip balm has an unmistakable market price, unlike a PDF. Scored 6 rather than higher because the same real cost that makes it convert is real cash out of a $2,700/mo operation, so it should be gated to a paid-order threshold (free item with purchase, or with a bundle) rather than given for a bare email — the tier-unlock rule below is the concrete form of that gate.
...
**Fit here (5/10):** Durable principle class, age irrelevant, but it cannot be used as intended: the no-new-products rule above gates catalog expansion, and a solo operator at $2,700/mo should not be launching product 13. It translates honestly as a scoring lens on the 12 SKUs that already exist — which item is stickiest, which has the lowest landed cost (lip balm), which is genuinely differentiated (the baking-soda-free variant). Score stickiness from the Shopify order history per the cohort-repurchase rule above rather than assuming deodorant and oral care win on category logic; that measured number is the only one of the four properties you can actually observe here. That scoring decides which SKU anchors a named bundle, which becomes the low-COGS entry/attraction offer, sample or free tier-unlock gift, and which carries the subscribe-and-save cadence. It also pairs directly with the differentiator audit above: the 'unique' score is what tells you which SKUs earn mechanism copy, and with the front-end/back-end split: the 'air' score picks the candidate front end, the 'sticky' score picks the back end. Free, no traffic, no attribution. Capped at 5 because the 'unique' criterion is largely unachievable in a saturated natural-deodorant category, and the low-COGS-entry insight is already half-covered by the splinter and lead-magnet rules above — the additive part is only the four-way scoring frame.
...
## Display the tiers inside the price selector itself — each tier carrying a struck-through comparison price and a free gift that unlocks at the higher tiers — instead of showing a single unit price.

**Why it works:** The strike-through reframes the comparison class so the tier reads as a saving rather than a bigger spend, and the unlockable gift gives the buyer a concrete reason to step up one tier. Together they move the decision the buyer is making from 'buy / don't buy' to 'which tier', which is a much easier question and one whose worst answer is still a sale.

**Evidence offered:** Assertion only, embedded as element 12 of a prescribed PDP layout. No test data.

**Fit here (8/10):** AOV is $50.46 across 12 SKUs and repeat rate is the binding constraint, so a tier ladder with a free-gift unlock — lip balm free at the 3-deodorant tier, say — both raises order value and puts a second SKU in the box, which is the cheapest way to seed a repeat purchase. Executable today in Shopify by one person with no budget. This is the display mechanic the neighbouring rules assume but never specify: buy-X-get-Y owns the ratio, the naming rule owns what each tier is called, the savings-framing rule owns the words on the label, and this owns the spend threshold and the strike-through inside the selector. It is also the concrete form of the paid-order gate on giving away something with a real market price — the gift is earned by hitting a tier, never handed out for a bare email. Two guards: the struck-through number must be a price you genuinely charge (a fabricated 'was' price is both a legal and a trust risk), and Amazon's list-price and promotion rules constrain how much of this transfers to the ~$1,800/mo channel — build it on Shopify first.
