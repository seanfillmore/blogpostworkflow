...
Generated 2026-07-25 by `scripts/bundle-economics.mjs`. Freight is **measured**, pulled live from Shopify's `shipping_labels` dataset.
...
|---|---|--:|--:|--:|--:|--:|--:|--:|--:|---|
| 90-Day Clean Swap | proposed | $207.00 | $159.00 | 23% | $45.30 | 3.84 | 12 | $7.94 | **$100.85** | ✅ scale (≥2× CAC) |
| 90-Day Coconut Reset | draft | $118.00 | $99.00 | 16% | $19.94 | 2.19 | 4 | $7.83 | **$68.06** | ✅ scale (≥2× CAC) |
| Head-to-Toe | proposed | $125.00 | $105.00 | 16% | $29.54 | 2.24 | 7 | $7.83 | **$64.29** | ✅ scale (≥2× CAC) |
...
| Foam Soap Bundle | draft | $52.00 | $20.02 | 62% | $17.31 | 4.05 | 3 | $21.31 | **$-19.48** | ❌ loses money |

## Why each one exists

- **90-Day Clean Swap** (proposed, $100.85) — Replace the four things you put on your body every day, for a quarter.
- **90-Day Coconut Reset** (draft, $68.06) — Built, lander done, delivery flow live. Blocked on 3 zero-stock scents + publish.
- **Head-to-Toe** (proposed, $64.29) — One of everything. Discovery and gifting.
...
- **Foam Soap Bundle** (draft, $-19.48) — MUST NOT PUBLISH — loses ~$19/order.
...
Cost is driven by **package**, not weight — real labels are flat $6.50–8.50 from 0.4 lb to 3.1 lb. Weighted average across all labels: **$7.33**.
