...
> |---|--:|--:|---|
> | **90-Day Coconut Reset** | **$121** | **10 (5 per scent)** | Rebuilt as a new product (`8500970881194` → `8566372303018`); the old 3 images did not survive. The 2 present were generated by Sean from the stored product photos, reviewed by him, and shipped 2026-07-31, one per variant. |
