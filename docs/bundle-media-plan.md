...
**Frame 5 — built 2026-08-01.** `data/brand/frames/99-coconut-reset-digital/frame-05-reviews.mjs`, rendered by `scripts/render-frame.mjs` to `data/brand/bundle-images/frame-05-reviews.jpg` (2048², 103 KB). **Not uploaded — awaiting review.**
