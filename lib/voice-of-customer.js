...
// see the "persona copy safety" section at the bottom. That import is the only
// one in this file and is deliberately from agents/ad-studio: health-claims.js
// is a pure, I/O-free policy module that imports nothing, exactly like
// agents/ad-studio/formats.js, which lib/ad-brief-plan.js already imports for
// the same reason. Importing it costs nothing and creates no cycle, so the gate
// stays in one place instead of being restated here.
