...
export function renderFlopSkipLines(skipped) {
  ...
  if (other) parts.push(`${other} BLOCKED/NOT_INDEXED/DEMOTE (a rewrite cannot fix these)`);
 ...
 *   no-demand    — BLOCKED: indexed, zero impressions after 30 days. No agent
 *                  fixes this; retarget, merge or leave it. A human's call.
...
export const FLOP_ACTIONS = {
  ...
  'no-demand': { automated: false, label: 'Indexed, zero impressions: retarget, merge or leave' },
