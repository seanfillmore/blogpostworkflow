 ...
 * Landing page × default channel group, with sessions/conversions/revenue, over a
 * date range. This is the backbone of SEO revenue attribution: filtering to the
 * "Organic Search" channel gives the revenue earned by each page's organic entry
 * traffic. Date range is inclusive; both dates are YYYY-MM-DD.
 */
