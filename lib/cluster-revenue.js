 ...
 * "coconut oil deodorant" is a deodorant post. Reordering silently re-buckets
 * revenue, and this list is also what defines the rows in seo-impact's
 * per-cluster report.
 *
 * 'bar soap' was folded into 'soap' on 2026-08-18. Kept apart they split one
 * category's evidence in two — soap read as a $0 dud on 180 clicks while bar
 * soap read as "untested" on 10 — so bar-soap-labelled work escaped the rule
 * that stops us adding to a category that does not earn. 'hand soap' stays
 * separate: it is its own product line, not a spelling of the same thing.
 */
const CLUSTERS = [
  'deodorant', 'toothpaste', 'lip balm', 'lip-balm', 'body lotion', 'body-lotion',
  'lotion', 'moisturizer', 'hand soap', 'hand-soap',
