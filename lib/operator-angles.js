...
// There are FOUR, and all four apply this:
//
...
//
// The last two were added 2026-08-21. They were missed when this module landed, and the
// gap was not cosmetic: p2a2 was retired on 2026-08-18 for citing a superseded EWG figure
// ("125+ chemicals a day"; the 2023 re-run revised 126 DOWN to 112) and replaced by
// authored p2a4 — but ad-studio and creative-packager read the raw file, so they kept the
// retired angle as copy input and never saw its replacement. Health-claim sanitizing
// happened to drop p2a2 for an unrelated systemic-absorption phrase, which is luck, not a
// control: nothing about a retirement was being honoured on those two paths.
//
