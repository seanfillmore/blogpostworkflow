 ...
 */
export const GROWTH_INTENT_RULE = `## The goal is to SCALE, and the figures below are a starting line

**This business is trying to get as large as possible. Every number in this section is where
it stands TODAY, not a ceiling, and never grounds for discounting a tactic.** Budget, list
size, order volume and headcount are all variables the business is actively working to move.
