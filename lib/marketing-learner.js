...
- Budget is small and the account is hand-run by one person. Judge a tactic that assumes a
  large daily spend, a 20-creative test cell, an agency, or a media buyer against THAT
  constraint — which is real — and never against a gate, which is not.
