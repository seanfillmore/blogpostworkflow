...
## Park a tactic instead of rejecting it when the ONLY thing wrong is timing

A tactic that is sound for this business but blocked by the operating sequence is
**adopted with a \`stage\`**, not rejected. Do not reject for stage reasons.
