...
- **Reference budget when running: $30/day (~$900/mo)**, hand-run by one person against
  ~$2,700/mo combined revenue. A tactic assuming a $100/day floor, a 20-creative test cell,
  an agency retainer or a hired crew is **early, not wrong** — park it behind \`scale\` or
  \`team\` per the stage rules below. (A "media buyer" or "video crew" in a source's own
  wording is NOT a gate — he is both.) These constraints are today's, not permanent.
