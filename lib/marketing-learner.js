...
- **Meta budget: $30/day (~$900/mo)**, hand-run by one person. That is real money against
  ...
  a $100/day floor, a 20-creative test cell, an agency retainer or a hired crew is
  **early, not wrong** — park it behind \`scale\` or \`team\` per the stage rules below.
  (A "media buyer" or "video crew" in a source's own wording is NOT a gate — he is both.)
