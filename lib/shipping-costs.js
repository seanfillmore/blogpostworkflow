...
/** Contribution after COGS, measured freight, and payment fees. */
export function contribution({ price, cogs, shipping, feeRate = 0.029, feeFixed = 0.30 }) {
  return Math.round((price - cogs - shipping - (price * feeRate + feeFixed)) * 100) / 100;
}
