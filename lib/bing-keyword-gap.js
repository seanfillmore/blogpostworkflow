...
/**
 * Trailing-90d AOV. Re-exported from `lib/business-baseline.js`, never re-declared —
 * this file and `lib/marketing-learner.js` each carried their own copy and both went
 * stale by 8.5% without either knowing. Structural break ~2025-09; never average across it.
 */
export const DEFAULT_AOV = AOV_TRAILING_90D;
