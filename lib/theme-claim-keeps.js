...
export const ACKNOWLEDGED_KEEPS = [
  ...
  // ── Added 2026-09-13 with the oral-care / child-safety vocabulary. Measured on the live
  // theme (38 templates, 546 prose strings, 219 alts): these four fields are the ONLY hits,
  // and each was read in full and judged. None has our product asserting it is safe for
  // kids or that it repairs teeth.
  {
    field: 'templates/product.landing-page-toothpaste.json/sections/collapsible-content/blocks/faq-2a/settings/heading',
    why: 'A QUESTION the customer asks ("Is it safe to swallow? Safe for kids?"). The answer beneath it asserts no safety: it lists the ingredients, says to rinse and spit, to supervise young kids, and to ask a pediatric dentist — the safety-referral shape already kept for faq-baby above.',
  },
  {
    field: 'templates/product.landing-page-toothpaste.json/sections/founder-block/blocks/founder-body/settings/text',
    why: 'Founder story about CONVENTIONAL toothpaste: its box said "do not swallow", so "why was I putting something in my mouth that wasn\'t safe to swallow?". A negation about another product, not a safety claim about ours.',
  },
  {
    field: 'templates/product.landing-page-toothpaste.json/sections/collapsible-content/blocks/faq-5/settings/row_content',
    why: 'Names what we deliberately LEAVE OUT — "Hydroxyapatite as a marketing-friendly remineralizer. We rely on baking soda neutralizing oral acid" — a sceptical description of other brands\' ingredient, not a claim that ours remineralizes.',
  },
  {
    field: 'templates/product.landing-page-liquid-soap.json/sections/collapsible-content/blocks/faq-3/settings/heading',
    why: 'A QUESTION the customer asks ("Is this safe for kids and sensitive hands?"). The answer describes what the formula omits and suitability for reactive skin; it never asserts safety.',
  },
];
