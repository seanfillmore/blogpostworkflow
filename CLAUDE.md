...
- `data/context/marketing-tactics.md` — fleet-readable projection of `.claude/skills/marketing-*/SKILL.md`, regenerated by `agents/marketing-learner` after every skill write (create, merge, or `--falsify`); `creative-packager` reads it as the ad-copy tactic menu and "Do not propose" blocklist.
