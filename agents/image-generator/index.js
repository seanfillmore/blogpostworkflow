...
SURREAL: yes or no — CHECK CAREFULLY FOR THESE COMMON AI FAILURES:
  ...
  * FAKE PRODUCTS: Are there any branded bottles, jars, or products in the image that were NOT in the reference images? The AI sometimes invents fake products (e.g. "aftercare oil", "healing balm", "organic coconut oil body lotion") that the brand doesn't sell. Count the number of distinct branded product types visible — if there are MORE branded products than reference images provided, the extra ones are fake. If you see ANY branded product that doesn't closely match a reference image provided, flag it as SURREAL.
